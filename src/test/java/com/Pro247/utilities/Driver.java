...
//           if we do not pass the driver from terminal then use the one properties file
            String browser = System.getProperty("browser") != null ? browser = System.getProperty("browser") : com.Pro247.utilities.ConfigurationReader.get("browser");
            switch (browser) {
                case "chrome":
